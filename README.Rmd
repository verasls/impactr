...
`impactr` is a package with functions to read, process and analyse raw accelerometer data related to mechanical loading variables. You can learn more about this package features and how to use in `vignette("impactr")`.
...
```
Some key functions for signal processing depend on the Python module SciPy. To install it, use the `install_scipy()` function:
